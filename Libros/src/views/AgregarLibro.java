...
public class AgregarLibro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Formato Tapa");

        jLabel4.setText("Cantidad Paginas");
        ...
        jRadioButton1.setMnemonic(68);
        jRadioButton1.setText("Dura");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setMnemonic('B');
        jRadioButton2.setText("Blanda");

        jTextField3.setText("jTextField3");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fantasia", "Accion", "Drama" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        char formato='B';
        if (buttonGroup1.getSelection().getMnemonic()==68) formato='D';
        ...
        boolean nuevo=jCheckBox1.isSelected();
        LibroController lc=new LibroController();
        try {
            lc.agregarLibro(codigo, nombre, categoria, autor, formato, nuevo, cantidad);
